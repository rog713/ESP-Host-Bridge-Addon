...
def agent_arg_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--activity-interval", type=float, default=10.0, help="Activity refresh interval in seconds (0 disables polling)")
    ap.add_argument("--activity-limit", type=int, default=12, help="Maximum number of Home Assistant activity rows to keep")
    ap.add_argument("--activity-lookback-minutes", type=int, default=180, help="Home Assistant logbook lookback window in minutes")
